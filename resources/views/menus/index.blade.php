            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8 p-5 my-auto align-center">
                        ...
                        <p class="col-md-10">
                            Disini kalian bisa nemuin semua menu dengan berbagai macam kategori yang dapat kalian pesan
        ...
        <div class="row g-3">
            ...
            <div class="col-md-8">
                <div class="alert alert-warning" role="alert">
                    Terdapat total {{ DB::table('menus')->count() }} menu yang tersedia di katalog menu restoran kami
                </div>
                <div class="row g-3">
